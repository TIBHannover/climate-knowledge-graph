...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="/work">
    <html>
      ...
      <body>
        <h1><xsl:value-of select="publication/title"/></h1>
  ...
  <xsl:template match="series">
    ...
    <!-- Front Matter -->
    <xsl:if test="front_matter/chapter">
      <h2>Front Matter</h2>
      <div class="section-box">
        <table class="chapters">
          ...
          <xsl:apply-templates select="front_matter/chapter" mode="front-matter"/>
        </table>
      </div>
    </xsl:if>
  ...
  <!-- Front matter chapter row -->
  <xsl:template match="chapter" mode="front-matter">
    <tr>
